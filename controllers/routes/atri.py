...
class Atri:
	def __init__(self, state: Any):
		...
		self.HeroConent = state["HeroConent"]
		self.HeroInnerFlex = state["HeroInnerFlex"]
		self.heroText = state["heroText"]
		self.bottomHeroContent = state["bottomHeroContent"]
		self.Flex184 = state["Flex184"]
		self.BoldHeroText = state["BoldHeroText"]
		self.heroImage = state["heroImage"]
		self.services = state["services"]
		self.servicesInnerDiv = state["servicesInnerDiv"]
		self.servicesSec1 = state["servicesSec1"]
		self.servicesSec2 = state["servicesSec2"]
		self.serviceblock1 = state["serviceblock1"]
		self.serviceblockdata1 = state["serviceblockdata1"]
		self.Flex34 = state["Flex34"]
		self.serviceblock2 = state["serviceblock2"]
		self.serviceBlockData2 = state["serviceBlockData2"]
		self.Flex36 = state["Flex36"]
		self.serviceblock3 = state["serviceblock3"]
		self.serviceBlockData3 = state["serviceBlockData3"]
		self.Flex38 = state["Flex38"]
		self.trusted = state["trusted"]
		self.TrustedInnerFlex = state["TrustedInnerFlex"]
		self.Images = state["Images"]
		self.Projectsection = state["Projectsection"]
		self.PSinnerDiv = state["PSinnerDiv"]
		self.PSTextFlex = state["PSTextFlex"]
		self.Flex62 = state["Flex62"]
		self.PSimages = state["PSimages"]
		...
		self.productDesign = state["productDesign"]
		...
		self.education = state["education"]
		...
		self.testimonials = state["testimonials"]
		...
		self.bluerHeroText = state["bluerHeroText"]
		...
		self.serviceimg1 = state["serviceimg1"]
		...
		self.trustedText = state["trustedText"]
	...
	@property
	def HeroConent(self):
		self._getter_access_tracker["HeroConent"] = {}
		return self._HeroConent
	@HeroConent.setter
	def HeroConent(self, new_state):
		self._setter_access_tracker["HeroConent"] = {}
		global default_state
		self._HeroConent = Flex(new_state, default_state["HeroConent"])

	@property
	def HeroInnerFlex(self):
		self._getter_access_tracker["HeroInnerFlex"] = {}
		return self._HeroInnerFlex
	@HeroInnerFlex.setter
	def HeroInnerFlex(self, new_state):
		self._setter_access_tracker["HeroInnerFlex"] = {}
		global default_state
		self._HeroInnerFlex = Flex(new_state, default_state["HeroInnerFlex"])

	@property
	def heroText(self):
		self._getter_access_tracker["heroText"] = {}
		return self._heroText
	@heroText.setter
	def heroText(self, new_state):
		self._setter_access_tracker["heroText"] = {}
		global default_state
		self._heroText = Flex(new_state, default_state["heroText"])

	@property
	def bottomHeroContent(self):
		self._getter_access_tracker["bottomHeroContent"] = {}
		return self._bottomHeroContent
	@bottomHeroContent.setter
	def bottomHeroContent(self, new_state):
		self._setter_access_tracker["bottomHeroContent"] = {}
		global default_state
		self._bottomHeroContent = Flex(new_state, default_state["bottomHeroContent"])
	...
	@property
	def BoldHeroText(self):
		self._getter_access_tracker["BoldHeroText"] = {}
		return self._BoldHeroText
	@BoldHeroText.setter
	def BoldHeroText(self, new_state):
		self._setter_access_tracker["BoldHeroText"] = {}
		global default_state
		self._BoldHeroText = Flex(new_state, default_state["BoldHeroText"])

	@property
	def heroImage(self):
		self._getter_access_tracker["heroImage"] = {}
		return self._heroImage
	@heroImage.setter
	def heroImage(self, new_state):
		self._setter_access_tracker["heroImage"] = {}
		global default_state
		self._heroImage = Flex(new_state, default_state["heroImage"])
	...
	def services(self, new_state):
		...
		global default_state
		self._services = Flex(new_state, default_state["services"])

	@property
	def servicesInnerDiv(self):
		self._getter_access_tracker["servicesInnerDiv"] = {}
		return self._servicesInnerDiv
	@servicesInnerDiv.setter
	def servicesInnerDiv(self, new_state):
		self._setter_access_tracker["servicesInnerDiv"] = {}
		global default_state
		self._servicesInnerDiv = Div(new_state, default_state["servicesInnerDiv"])

	@property
	def servicesSec1(self):
		self._getter_access_tracker["servicesSec1"] = {}
		return self._servicesSec1
	@servicesSec1.setter
	def servicesSec1(self, new_state):
		self._setter_access_tracker["servicesSec1"] = {}
		global default_state
		self._servicesSec1 = Flex(new_state, default_state["servicesSec1"])

	@property
	def servicesSec2(self):
		self._getter_access_tracker["servicesSec2"] = {}
		return self._servicesSec2
	@servicesSec2.setter
	def servicesSec2(self, new_state):
		self._setter_access_tracker["servicesSec2"] = {}
		global default_state
		self._servicesSec2 = Flex(new_state, default_state["servicesSec2"])

	@property
	def serviceblock1(self):
		self._getter_access_tracker["serviceblock1"] = {}
		return self._serviceblock1
	@serviceblock1.setter
	def serviceblock1(self, new_state):
		self._setter_access_tracker["serviceblock1"] = {}
		global default_state
		self._serviceblock1 = Div(new_state, default_state["serviceblock1"])

	@property
	def serviceblockdata1(self):
		self._getter_access_tracker["serviceblockdata1"] = {}
		return self._serviceblockdata1
	@serviceblockdata1.setter
	def serviceblockdata1(self, new_state):
		self._setter_access_tracker["serviceblockdata1"] = {}
		global default_state
		self._serviceblockdata1 = Flex(new_state, default_state["serviceblockdata1"])
	...
	@property
	def serviceblock2(self):
		self._getter_access_tracker["serviceblock2"] = {}
		return self._serviceblock2
	@serviceblock2.setter
	def serviceblock2(self, new_state):
		self._setter_access_tracker["serviceblock2"] = {}
		global default_state
		self._serviceblock2 = Div(new_state, default_state["serviceblock2"])

	@property
	def serviceBlockData2(self):
		self._getter_access_tracker["serviceBlockData2"] = {}
		return self._serviceBlockData2
	@serviceBlockData2.setter
	def serviceBlockData2(self, new_state):
		self._setter_access_tracker["serviceBlockData2"] = {}
		global default_state
		self._serviceBlockData2 = Flex(new_state, default_state["serviceBlockData2"])
	...
	@property
	def serviceblock3(self):
		self._getter_access_tracker["serviceblock3"] = {}
		return self._serviceblock3
	@serviceblock3.setter
	def serviceblock3(self, new_state):
		self._setter_access_tracker["serviceblock3"] = {}
		global default_state
		self._serviceblock3 = Div(new_state, default_state["serviceblock3"])

	@property
	def serviceBlockData3(self):
		self._getter_access_tracker["serviceBlockData3"] = {}
		return self._serviceBlockData3
	@serviceBlockData3.setter
	def serviceBlockData3(self, new_state):
		self._setter_access_tracker["serviceBlockData3"] = {}
		global default_state
		self._serviceBlockData3 = Flex(new_state, default_state["serviceBlockData3"])
	...
	@property
	def trusted(self):
		self._getter_access_tracker["trusted"] = {}
		return self._trusted
	@trusted.setter
	def trusted(self, new_state):
		self._setter_access_tracker["trusted"] = {}
		global default_state
		self._trusted = Flex(new_state, default_state["trusted"])

	@property
	def TrustedInnerFlex(self):
		self._getter_access_tracker["TrustedInnerFlex"] = {}
		return self._TrustedInnerFlex
	@TrustedInnerFlex.setter
	def TrustedInnerFlex(self, new_state):
		self._setter_access_tracker["TrustedInnerFlex"] = {}
		global default_state
		self._TrustedInnerFlex = Flex(new_state, default_state["TrustedInnerFlex"])

	@property
	def Images(self):
		self._getter_access_tracker["Images"] = {}
		return self._Images
	@Images.setter
	def Images(self, new_state):
		self._setter_access_tracker["Images"] = {}
		global default_state
		self._Images = Flex(new_state, default_state["Images"])

	@property
	def Projectsection(self):
		self._getter_access_tracker["Projectsection"] = {}
		return self._Projectsection
	@Projectsection.setter
	def Projectsection(self, new_state):
		self._setter_access_tracker["Projectsection"] = {}
		global default_state
		self._Projectsection = Flex(new_state, default_state["Projectsection"])

	@property
	def PSinnerDiv(self):
		self._getter_access_tracker["PSinnerDiv"] = {}
		return self._PSinnerDiv
	@PSinnerDiv.setter
	def PSinnerDiv(self, new_state):
		self._setter_access_tracker["PSinnerDiv"] = {}
		global default_state
		self._PSinnerDiv = Div(new_state, default_state["PSinnerDiv"])

	@property
	def PSTextFlex(self):
		self._getter_access_tracker["PSTextFlex"] = {}
		return self._PSTextFlex
	@PSTextFlex.setter
	def PSTextFlex(self, new_state):
		self._setter_access_tracker["PSTextFlex"] = {}
		global default_state
		self._PSTextFlex = Flex(new_state, default_state["PSTextFlex"])
	...
	@property
	def PSimages(self):
		self._getter_access_tracker["PSimages"] = {}
		return self._PSimages
	@PSimages.setter
	def PSimages(self, new_state):
		self._setter_access_tracker["PSimages"] = {}
		global default_state
		self._PSimages = Flex(new_state, default_state["PSimages"])
	...
	@property
	def Blogs(self):
		self._getter_access_tracker["Blogs"] = {}
		return self._Blogs
	@Blogs.setter
	def Blogs(self, new_state):
		self._setter_access_tracker["Blogs"] = {}
		global default_state
		self._Blogs = Flex(new_state, default_state["Blogs"])
	...
	@property
	def productDesign(self):
		self._getter_access_tracker["productDesign"] = {}
		return self._productDesign
	@productDesign.setter
	def productDesign(self, new_state):
		self._setter_access_tracker["productDesign"] = {}
		global default_state
		self._productDesign = Flex(new_state, default_state["productDesign"])
	...
	@property
	def education(self):
		self._getter_access_tracker["education"] = {}
		return self._education
	@education.setter
	def education(self, new_state):
		self._setter_access_tracker["education"] = {}
		global default_state
		self._education = Flex(new_state, default_state["education"])
	...
	@testimonials.setter
	def testimonials(self, new_state):
		self._setter_access_tracker["testimonials"] = {}
		global default_state
		self._testimonials = Flex(new_state, default_state["testimonials"])
	...
	@property
	def faq(self):
		self._getter_access_tracker["faq"] = {}
		return self._faq
	@faq.setter
	def faq(self, new_state):
		self._setter_access_tracker["faq"] = {}
		global default_state
		self._faq = Flex(new_state, default_state["faq"])
	...
	def Footer(self, new_state):
		...
		global default_state
		self._Footer = Flex(new_state, default_state["Footer"])
	...
	@property
	def bluerHeroText(self):
		self._getter_access_tracker["bluerHeroText"] = {}
		return self._bluerHeroText
	@bluerHeroText.setter
	def bluerHeroText(self, new_state):
		self._setter_access_tracker["bluerHeroText"] = {}
		global default_state
		self._bluerHeroText = TextBox(new_state, default_state["bluerHeroText"])
	...
	@property
	def serviceimg1(self):
		self._getter_access_tracker["serviceimg1"] = {}
		return self._serviceimg1
	@serviceimg1.setter
	def serviceimg1(self, new_state):
		self._setter_access_tracker["serviceimg1"] = {}
		global default_state
		self._serviceimg1 = Image(new_state, default_state["serviceimg1"])
	...
	@property
	def trustedText(self):
		self._getter_access_tracker["trustedText"] = {}
		return self._trustedText
	@trustedText.setter
	def trustedText(self, new_state):
		self._setter_access_tracker["trustedText"] = {}
		global default_state
		self._trustedText = TextBox(new_state, default_state["trustedText"])
	...
	def _to_json_fields(self):
		return {
			...
			"HeroConent": self._HeroConent,
			"HeroInnerFlex": self._HeroInnerFlex,
			"heroText": self._heroText,
			"bottomHeroContent": self._bottomHeroContent,
			"Flex184": self._Flex184,
			"BoldHeroText": self._BoldHeroText,
			"heroImage": self._heroImage,
			"services": self._services,
			"servicesInnerDiv": self._servicesInnerDiv,
			"servicesSec1": self._servicesSec1,
			"servicesSec2": self._servicesSec2,
			"serviceblock1": self._serviceblock1,
			"serviceblockdata1": self._serviceblockdata1,
			"Flex34": self._Flex34,
			"serviceblock2": self._serviceblock2,
			"serviceBlockData2": self._serviceBlockData2,
			"Flex36": self._Flex36,
			"serviceblock3": self._serviceblock3,
			"serviceBlockData3": self._serviceBlockData3,
			"Flex38": self._Flex38,
			"trusted": self._trusted,
			"TrustedInnerFlex": self._TrustedInnerFlex,
			"Images": self._Images,
			"Projectsection": self._Projectsection,
			"PSinnerDiv": self._PSinnerDiv,
			"PSTextFlex": self._PSTextFlex,
			"Flex62": self._Flex62,
			"PSimages": self._PSimages,
			"Div13": self._Div13,
			"Flex64": self._Flex64,
			"Div14": self._Div14,
			"Flex65": self._Flex65,
			...
			"Flex76": self._Flex76,
			"Flex77": self._Flex77,
			"productDesign": self._productDesign,
			"Flex79": self._Flex79,
			"Flex81": self._Flex81,
			"Div19": self._Div19,
			"Div20": self._Div20,
			...
			"bluerHeroText": self._bluerHeroText,
